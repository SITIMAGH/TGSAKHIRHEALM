...
<body class="light">
    <div class="wrapper vh-100">
        <div class="row align-items-center h-100">
            <form action="<?php echo e(base_url()); ?>auth/do_login" method="POST" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
...
</html><?php /**PATH C:\xampp\htdocs\healme\application\views/login.blade.php ENDPATH**/ ?>