    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item w-100">
                <a class="nav-link" href="<?php echo e(base_url()); ?>promo">
            ...
            <li class="nav-item w-100">
                <a class="nav-link" href="<?php echo e(base_url()); ?>dokter">
                    <i class="fe fe-users fe-16"></i>
                    <span class="ml-3 item-text">Master Dokter</span>
                </a>
            </li>
            <li class="nav-item w-100">
                <a class="nav-link" href="<?php echo e(base_url()); ?>obat">
                    <i class="fe fe-archive fe-16"></i>
                    <span class="ml-3 item-text">Master Obat</span>
                </a>
            </li>
            <li class="nav-item w-100">
                <a class="nav-link" href="<?php echo e(base_url()); ?>voucher">
                    <i class="fe fe-archive fe-16"></i>
                    <span class="ml-3 item-text">Master Voucher</span>
                </a>
            </li>
            <li class="nav-item w-100">
                <a class="nav-link" href="<?php echo e(base_url()); ?>news">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="transaction">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(base_url()); ?>transaksi/chat">
                            <span class="ml-1 item-text">Chat</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(base_url()); ?>transaksi/obat">
                            <span class="ml-1 item-text">Obat</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(base_url()); ?>transaksi/voucher">
            ...
            <li class="nav-item w-100 ">
                <a class="nav-link" href="<?php echo e(base_url()); ?>profile">
...
</aside><?php /**PATH C:\xampp\htdocs\healme\application\views/layouts/sidebar.blade.php ENDPATH**/ ?>