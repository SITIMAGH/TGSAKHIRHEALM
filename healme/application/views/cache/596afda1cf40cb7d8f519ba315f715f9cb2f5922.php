...
<?php $__env->startSection('title', 'Detail Transaksi Voucher'); ?>

<?php $__env->startSection('page_title', 'Detail Transaksi Voucher'); ?>

<?php $__env->startSection('content'); ?>
<div class="row justify-content-center">
    <div class="col-12 col-md-6">
        <div class="card shadow">
            <form class="card-body" action="<?php echo e(base_url()); ?>transaksi/voucher/status/<?php echo e($data->trxId); ?>" method="POST">
