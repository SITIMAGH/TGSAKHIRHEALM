...
<div class="row">
    <div class="col-12">
        <div class="card shadow">
            <form class="card-body" action="<?php echo e(base_url() . ADMINPATH); ?>/products/update/<?php echo e($data->id); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/akhotel1/public_html/application/views/admin/products/edit.blade.php ENDPATH**/ ?>