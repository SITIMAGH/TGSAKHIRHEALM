                    ...
                    <div class="d-flex align-items-center" style="height: 100vh; width: 100%;">
                        <form action="<?php echo e(base_url()); ?>auth/do_daftar" method="POST" class="w-100">
                            ...
                            <div class="form-group mt-3 mb-2">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Fullname, Exp : John"
                                    required>
                            </div>
                            <div class="form-group mb-2">
                                
                                <input type="number" name="phone" class="form-control"
                                    placeholder="Phone, Exp : 0851234567" required>
                            </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="password" name="password" class="form-control"
                                    placeholder="Password, Exp : john123" required>
                            </div>
                            <div class="form-group mb-2">
                                
                                <input type="text" name="reff" class="form-control"
                                    value="<?php echo e(isset($_GET['invite']) ? $_GET['invite'] : ''); ?>"
                                    placeholder="Refferal, Exp : Fx12H">
                            </div>
                            <div class="form-group mb-2">
                                
                                <input type="number" name="pin" class="form-control"
                                    placeholder="Pin Transaction, Exp : 1234" required>
                            </div>
                            <div class="form-group mt-3">
                                <input type="submit" value="Daftar" class="btn btn-warning w-100">
                            </div>
                            <div class="text-center mt-2">Sudah Punya Akun? <a
                                    href="<?php echo e(base_url()); ?>auth/login">Login</a></div>
...
</html><?php /**PATH /home/akhotel1/public_html/application/views/daftar.blade.php ENDPATH**/ ?>