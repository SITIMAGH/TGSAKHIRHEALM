...
if ($CI->session->userdata('login_admin') == null) {
    ...
    if(model('Madmins')->get(['id' => $log->id])->row()->password != $log->password){
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | HEALME</title>
    <!-- Simple bar CSS -->
            ...
            <ul class="nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="<?php echo e(base_url()  . '/auth/logout'); ?>">Logout</a>
                    </div>
                </li>
            </ul>
        </nav>
...
</html><?php /**PATH C:\xampp\htdocs\healme\application\views/layouts/app.blade.php ENDPATH**/ ?>