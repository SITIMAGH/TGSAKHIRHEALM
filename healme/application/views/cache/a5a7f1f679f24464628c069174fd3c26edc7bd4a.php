...
<?php $__env->startSection('page_title', 'News'); ?>
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header">
                <a href="<?php echo e(base_url()); ?>news/add" class="btn btn-sm btn-primary shadow"><i
                    ...
                    <table class="table table-striped table-hover text-center" style="white-space: nowrap;"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo e(base_url() . 'files/' . $item->image); ?>" width="80" alt=""></td>
                                <td><?php echo e($item->created_at); ?></td>
                                <td>
                                    <a href="<?php echo e(base_url()); ?>news/edit/<?php echo e($item->id); ?>" class="btn btn-sm btn-info"><i
                                            class="fe fe-edit fe-16"></i></a>
                                    <a onclick="return confirm('Apakah anda ingin menghapus data ini?')"
                                        href="<?php echo e(base_url()); ?>news/delete/<?php echo e($item->id); ?>"
