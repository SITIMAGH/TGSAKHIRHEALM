                    ...
                    <div class="d-flex align-items-center" style="height: 100vh; width: 100%;">
                        <form action="<?php echo e(base_url()); ?>auth/do_login" method="POST" class="w-100">
                            <center><img
                                    ...
                                    alt="" width="200" class="rounded-lg"></center>
                            ...
                            <div class="form-group mb-3">
                                <input type="password" name="password" placeholder="Password"
                                    class="form-control radiusfull" required>
                            </div>
                            
                            <div class="form-group">
                                <input type="submit" value="Login" class="btn w-100 radiusfull text-light" style="background-color: #d920a1;">
                            </div>
                            <div class="text-center mt-2 text-light">Belum Punya Akun? <a
                                    href="<?php echo e(base_url()); ?>auth/daftar" class="text-warning">Daftar</a></div>
...
</html><?php /**PATH C:\newxampp2\htdocs\ponselkita\application\views/login.blade.php ENDPATH**/ ?>