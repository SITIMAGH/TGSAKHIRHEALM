...
<?php $__env->startSection('page_title', 'Obat'); ?>
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header">
                <a href="<?php echo e(base_url()); ?>obat/add" class="btn btn-sm btn-primary shadow"><i
                    ...
                    <table class="table table-striped table-hover text-center" style="white-space: nowrap;"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(base_url()); ?>obat/edit/<?php echo e($item->id); ?>" class="btn btn-sm btn-info"><i
                                            class="fe fe-edit fe-16"></i></a>
                                    <a onclick="return confirm('Apakah anda ingin menghapus data ini?')"
                                        href="<?php echo e(base_url()); ?>obat/delete/<?php echo e($item->id); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\healme\application\views/obat/index.blade.php ENDPATH**/ ?>