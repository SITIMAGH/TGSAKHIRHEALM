...
@section('title', 'Detail Transaksi Voucher')

@section('page_title', 'Detail Transaksi Voucher')

@section('content')
<div class="row justify-content-center">
    <div class="col-12 col-md-6">
        <div class="card shadow">
            <form class="card-body" action="{{ base_url() }}transaksi/voucher/status/{{ $data->trxId }}" method="POST">
